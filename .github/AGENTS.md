...
Web workflows can validate formalization candidate shape and immutable digests only. They cannot sign kernel, axiom, statement-identity, statement-faithfulness, freshness, sandbox-external replay, EvidenceLink, Result or Solution capabilities; CI green remains transport/runtime state.
