...
├── FORMAL_VERIFICATION_INFRASTRUCTURE_STANDARD.md # 形式化就绪、Lean/Mathlib 与 typed terminal gate
...
`FORMAL_VERIFICATION_INFRASTRUCTURE_STANDARD.md` 与对应机器策略/Lean lock 定义 candidate、native、adversarial 三档保证。标准更新不得把 native build 冒充 terminal proof，也不得绕过 statement-faithfulness、freshness、external replay、root closure 或 conflict freeze。
